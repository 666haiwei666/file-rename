...
const { readFile, getDirFiles, fetchTeample, extNameFn, writeFile, getFileStat, isAbsolute, reName, isHasExtname } = require("./utils/fsOperation")
...
async function createMcAction(project) {
    ...
    try {
        ...
        checkNameSameFile(cacheObj, floderPath)
